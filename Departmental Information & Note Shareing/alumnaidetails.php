    ...
    <div class="w3-col m8 w3-container w3-padding">
      ...
      <div class="w3-border w3-padding-large">
        ...
        <div class="w3-padding w3-light-grey">
          ...
          ?>
                <button class="w3-button w3-green w3-hover-green w3-margin-right w3-round" onclick="document.getElementById('edit').style.display='block'"><b>EDIT</b></button><button class="w3-button w3-red w3-hover-red rfont w3-text-white w3-round" onclick="document.getElementById('signout').style.display='block'"><b>LOG OUT</b></button>
          <?php   }else{  ?>
